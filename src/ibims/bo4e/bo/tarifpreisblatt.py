...
class Tarifpreisblatt(BaseModel):
    ...
    """
    Festlegung von Garantien fÃ¼r bestimmte Preisanteile
    """
    ...
    """
    Auf- und AbschlÃ¤ge auf die Preise oder Kosten
    """
    ...
    """
    Die festgelegten Preise, z.B. fÃ¼r Arbeitspreis, Grundpreis etc.
    """
